...
// Shows - {name:String, home_page:url, description:String, s3:Url, created_at:Date, show_route:String} //route is how name with spaces replaced by -, e.g. Joe-Rogan-Experience
Shows = new Meteor.Collection('shows');

// Episode - {name:String, home_url:String, show_id:String, show_route:String, number:Number, edited:Boolean, seconds:Number, s3:Url, created_at:Date, updated_at:Date, home_notes:String}
