...
Meteor.startup(function() {
    if (Shows.find().count() === 0) {
        ...
        var nextmarket_id = Shows.insert(
            {name:'NextMarket', home_url:'http://nextmarket.co/pages/podcast', show_route:'NextMarket',
             created_at:timestamp, description:"The NextMarket podcast features Michael Wolf's conversations with some of the biggest and most interesting names in tech, media and podcasting."});
        var commonsense_id = Shows.insert(
            {name:'Common Sense with Dan Carlin', home_url:'http://www.dancarlin.com/disp.php/cs',
             show_route:'Common-Sense-With-Dan-Carlin', created_at:timestamp,
        ...
        var nextmarket_66_id = Episodes.insert(
            {name:'Robert Scoble', home_url:'http://nextmarket.co/blogs/conversations/10454341-66-robert-scoble-on-google-glass-his-new-book-and-the-evolution-of-tech-blogging',
             created_at:timestamp, updated_at:null, show_id:nextmarket_id, edited:false,
             s3:'http://s3timeliner.s3.amazonaws.com/nextmarket_podcast/NextMarket66.mp3',
             home_notes:'Slightly too lazy to incorporate', seconds:2962, number:66,
             show_route:'NextMarket'});
        var commonsense_257_id = Episodes.insert(
            {name:'Monopolizing the Democracy', home_url:'http://podbay.fm/show/155974141/e/1373435424',
